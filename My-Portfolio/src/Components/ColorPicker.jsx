...
export default function ColorPicker() {
  ...
  return (
    <div className={`absolute left-20 top-0 transform ${showColorPicker ? "translate-x-0" : "-translate-x-72"} transition-transform duration-300 bg-transparent backdrop-blur rounded-lg px-3 py-2 border-[1px] border-${themeChange ? "gray-300" : "gray-500"}`}>
