    ...
    <section id="Projects" className={`${themeChange ? "bg-[#ecf0f3]" : "bg-[#111111]"}`}>
      <div className="w-[90%] md:max-w-[68%] m-auto pb-1 md:py-28 relative">
        ...
        <div className="md:mt-10 mb-10 md:mb-16 flex flex-col md:flex-row justify-between gap-5 md:gap-20 relative">
          <div className="hidden md:block h-[2px] absolute left-1/4 right-1/2 top-1/2 -translate-y-1/2" style={{ backgroundColor: colorHandle }}></div>
        ...
        <div className="mb-10 md:mb-16 flex flex-col md:flex-row justify-between gap-5 md:gap-20 relative">
          ...
          <div className="hidden md:block h-[2px] absolute left-1/2 right-1/4 top-1/2 -translate-y-1/2" style={{ backgroundColor: colorHandle }}></div>
          <div className="hidden md:block h-4 w-4 rounded-full absolute z-10 left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 border-[2px]" style={{ backgroundColor: `${themeChange ? "#ecf0f3" : "#111111"}`, borderColor: colorHandle }}></div>
        ...
        <div className="mb-10 md:mb-16 flex flex-col md:flex-row justify-between gap-5 md:gap-20 relative">
          <div className="hidden md:block h-[2px] absolute left-1/4 right-1/2 top-1/2 -translate-y-1/2 opacity-70" style={{ backgroundColor: colorHandle }}></div>
          <div className="hidden md:block h-4 w-4 rounded-full absolute z-10 left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 border-[2px]" style={{ backgroundColor: `${themeChange ? "#ecf0f3" : "#111111"}`, borderColor: colorHandle }}></div>
          <div className="w-full relative">
            <div>
