    ...
    <section className={`w-[95%] md:w-[68%] flex absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 py-3 px-3 md:py-16 md:px-20 rounded-xl border-[1px] z-30 ${themeChange ? "bg-white border-gray-300" : "bg-[#191919] border-gray-500"}`}>
      <div className="flex flex-col md:flex-row justify-between m-auto md:gap-10">
        ...
        <div className="w-full md:w-[50%] text-start">
          ...
          <p className="mt-2 md:mt-4 tracking-wide text-[15px] md:text-[17px] leading-5 md:leading-6" style={{color: themeChange ? "#646464" : "#c7c7c7"}} >Hi, I am Ashish Sharma, I can build the front-end portion of websites the part users see and interact with. A dedicated and ambitious Frontend Developer seeking a role in an organization to utilize his skills and experience to contribute to the success of the organization while continuously developing his knowledge and expertise.  and I can also create websites using web languages such as HTML, CSS, JavaScript and React.JS that allow users to access and interact with the site.</p>
